...
var kSecBase64Encoding*: CFStringRef

## !
##     @abstract Specifies a base 32 encoding
##

var kSecBase32Encoding*: CFStringRef

## !
##     @abstract Specifies a compressed encoding.
##

var kSecZLibEncoding*: CFStringRef
...
var kSecEncodeTypeAttribute*: CFStringRef

var kSecLineLength64*: CFStringRef

var kSecLineLength76*: CFStringRef
...
var kSecEncodeLineLengthAttribute*: CFStringRef

var kSecCompressionRatio*: CFStringRef
...
proc SecEncodeTransformCreate*(encodeType: CFTypeRef; error: ptr CFErrorRef): SecTransformRef