...
type
  SecIdentitySearchRef* = ptr OpaqueSecIdentitySearchRef
...
proc SecIdentitySearchGetTypeID*(): CFTypeID
## !
...
proc SecIdentitySearchCreate*(keychainOrArray: CFTypeRef; keyUsage: CSSM_KEYUSE;
                             searchRef: ptr SecIdentitySearchRef): OSStatus
## !
...
proc SecIdentitySearchCopyNext*(searchRef: SecIdentitySearchRef;
