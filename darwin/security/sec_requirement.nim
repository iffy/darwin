...
proc SecRequirementGetTypeID*(): CFTypeID
## !
...
proc SecRequirementCreateWithData*(data: CFDataRef; flags: SecCSFlags;
...
proc SecRequirementCreateWithString*(text: CFStringRef; flags: SecCSFlags;
                                    requirement: ptr SecRequirementRef): OSStatus
proc SecRequirementCreateWithStringAndErrors*(text: CFStringRef; flags: SecCSFlags;
    errors: ptr CFErrorRef; requirement: ptr SecRequirementRef): OSStatus
## !
...
proc SecRequirementCopyData*(requirement: SecRequirementRef; flags: SecCSFlags;
                            data: ptr CFDataRef): OSStatus
## !
...
proc SecRequirementCopyString*(requirement: SecRequirementRef; flags: SecCSFlags;
                              text: ptr CFStringRef): OSStatus