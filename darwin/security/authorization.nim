...
const
  ...
  kAuthorizationFlagPreAuthorize* = (1 shl 4) ##  private bits (do not use)
...
type
  AuthorizationRef* = ptr AuthorizationOpaqueRef
...
type
  AuthorizationItem* {.bycopy.} = object
...
type
  AuthorizationItemSet* {.bycopy.} = object
    count*: UInt32
    items*: ptr AuthorizationItem


var kAuthorizationExternalFormLength*: csize = 32
...
type
  AuthorizationExternalForm* {.bycopy.} = object
    bytes*: array[kAuthorizationExternalFormLength, char]
...
proc AuthorizationCreate*(rights: ptr AuthorizationRights;
                         environment: ptr AuthorizationEnvironment;
                         flags: AuthorizationFlags;
                         authorization: ptr AuthorizationRef): OSStatus
## !
...
proc AuthorizationFree*(authorization: AuthorizationRef; flags: AuthorizationFlags): OSStatus
## !
...
proc AuthorizationCopyRights*(authorization: AuthorizationRef;
                             rights: ptr AuthorizationRights;
                             environment: ptr AuthorizationEnvironment;
                             flags: AuthorizationFlags;
                             authorizedRights: ptr ptr AuthorizationRights): OSStatus
## !
...
proc AuthorizationCopyInfo*(authorization: AuthorizationRef;
                           tag: AuthorizationString;
                           info: ptr ptr AuthorizationItemSet): OSStatus
## !
...
proc AuthorizationMakeExternalForm*(authorization: AuthorizationRef;
                                   extForm: ptr AuthorizationExternalForm): OSStatus
## !
...
proc AuthorizationCreateFromExternalForm*(extForm: ptr AuthorizationExternalForm;
    authorization: ptr AuthorizationRef): OSStatus
## !
...
proc AuthorizationFreeItemSet*(set: ptr AuthorizationItemSet): OSStatus
## !
...
proc AuthorizationExecuteWithPrivileges*(authorization: AuthorizationRef;
                                        pathToTool: cstring;
                                        options: AuthorizationFlags;
                                        arguments: cstringArray;
                                        communicationsPipe: ptr ptr FILE): OSStatus
## !
...
proc AuthorizationCopyPrivilegedReference*(authorization: ptr AuthorizationRef;
    flags: AuthorizationFlags): OSStatus