...
type
  SecPolicySearchRef* = ptr OpaquePolicySearchRef
...
proc SecPolicySearchGetTypeID*(): CFTypeID
## !
...
proc SecPolicySearchCreate*(certType: CSSM_CERT_TYPE; policyOID: ptr CSSM_OID;
                           value: ptr CSSM_DATA; searchRef: ptr SecPolicySearchRef): OSStatus
## !
...
proc SecPolicySearchCopyNext*(searchRef: SecPolicySearchRef;
                             policyRef: ptr SecPolicyRef): OSStatus