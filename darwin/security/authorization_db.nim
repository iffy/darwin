...
proc AuthorizationRightGet*(rightName: cstring;
                           rightDefinition: ptr CFDictionaryRef): OSStatus
## !
...
proc AuthorizationRightSet*(authRef: AuthorizationRef; rightName: cstring;
                           rightDefinition: CFTypeRef;
                           descriptionKey: CFStringRef; bundle: CFBundleRef;
                           localeTableName: CFStringRef): OSStatus
## !
...
proc AuthorizationRightRemove*(authRef: AuthorizationRef; rightName: cstring): OSStatus