...
proc SecTrustedApplicationGetTypeID*(): CFTypeID
## !
...
proc SecTrustedApplicationCreateFromPath*(path: cstring;
    app: ptr SecTrustedApplicationRef): OSStatus
## !
...
proc SecTrustedApplicationCopyData*(appRef: SecTrustedApplicationRef;
...
proc SecTrustedApplicationSetData*(appRef: SecTrustedApplicationRef;
                                  data: CFDataRef): OSStatus