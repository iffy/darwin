...
var kSecAttrAccess*: CFStringRef
...
var kSecAttrIsSensitive*: CFStringRef

var kSecAttrIsExtractable*: CFStringRef

var kSecAttrApplicationTag*: CFStringRef

var kSecAttrKeyType*: CFStringRef

var kSecAttrPRF*: CFStringRef

var kSecAttrSalt*: CFStringRef

var kSecAttrRounds*: CFStringRef
...
var kSecAttrSyncViewHint*: CFStringRef

var kSecAttrTokenID*: CFStringRef

var kSecAttrPersistantReference*: CFStringRef

var kSecAttrPersistentReference*: CFStringRef
...
var kSecAttrKeyTypeDSA*: CFStringRef

var kSecAttrKeyTypeAES*: CFStringRef

var kSecAttrKeyTypeDES*: CFStringRef

var kSecAttrKeyType3DES*: CFStringRef

var kSecAttrKeyTypeRC4*: CFStringRef

var kSecAttrKeyTypeRC2*: CFStringRef

var kSecAttrKeyTypeCAST*: CFStringRef

var kSecAttrKeyTypeECDSA*: CFStringRef

var kSecAttrKeyTypeEC*: CFStringRef

var kSecAttrKeyTypeECSECPrimeRandom*: CFStringRef
...
var kSecAttrPRFHmacAlgSHA1*: CFStringRef

var kSecAttrPRFHmacAlgSHA224*: CFStringRef

var kSecAttrPRFHmacAlgSHA256*: CFStringRef

var kSecAttrPRFHmacAlgSHA384*: CFStringRef

var kSecAttrPRFHmacAlgSHA512*: CFStringRef
...
var kSecMatchSubjectStartsWith*: CFStringRef

var kSecMatchSubjectEndsWith*: CFStringRef

var kSecMatchSubjectWholeString*: CFStringRef

var kSecMatchCaseInsensitive*: CFStringRef

var kSecMatchDiacriticInsensitive*: CFStringRef

var kSecMatchWidthInsensitive*: CFStringRef
...
var kSecUseKeychain*: CFStringRef

var kSecUseOperationPrompt*: CFStringRef

var kSecUseNoAuthenticationUI*: CFStringRef

var kSecUseAuthenticationUI*: CFStringRef

var kSecUseAuthenticationContext*: CFStringRef

var kSecUseDataProtectionKeychain*: CFStringRef
...
var kSecUseAuthenticationUIAllow*: CFStringRef

var kSecUseAuthenticationUIFail*: CFStringRef

var kSecUseAuthenticationUISkip*: CFStringRef
...
var kSecAttrTokenIDSecureEnclave*: CFStringRef
...
var kSecAttrAccessGroupToken*: CFStringRef
...
proc SecItemUpdate*(query: CFDictionaryRef; attributesToUpdate: CFDictionaryRef): OSStatus
## !
