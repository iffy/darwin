...
var kSecPropertyTypeTitle*: CFStringRef

var kSecPropertyTypeError*: CFStringRef
...
var kSecTrustEvaluationDate*: CFStringRef

var kSecTrustExtendedValidation*: CFStringRef

var kSecTrustOrganizationName*: CFStringRef

var kSecTrustResultValue*: CFStringRef

var kSecTrustRevocationChecked*: CFStringRef

var kSecTrustRevocationValidUntilDate*: CFStringRef

var kSecTrustCertificateTransparency*: CFStringRef

var kSecTrustCertificateTransparencyWhiteList*: CFStringRef
...
proc SecTrustGetTypeID*(): CFTypeID
## !
...
proc SecTrustCreateWithCertificates*(certificates: CFTypeRef; policies: CFTypeRef;
                                    trust: ptr SecTrustRef): OSStatus
## !
...
proc SecTrustSetPolicies*(trust: SecTrustRef; policies: CFTypeRef): OSStatus
## !
...
proc SecTrustCopyPolicies*(trust: SecTrustRef; policies: ptr CFArrayRef): OSStatus
## !
...
proc SecTrustSetNetworkFetchAllowed*(trust: SecTrustRef; allowFetch: Boolean): OSStatus
## !
...
proc SecTrustGetNetworkFetchAllowed*(trust: SecTrustRef; allowFetch: ptr Boolean): OSStatus
## !
...
proc SecTrustSetAnchorCertificates*(trust: SecTrustRef;
                                   anchorCertificates: CFArrayRef): OSStatus
## !
...
proc SecTrustSetAnchorCertificatesOnly*(trust: SecTrustRef;
                                       anchorCertificatesOnly: Boolean): OSStatus
## !
...
proc SecTrustCopyCustomAnchorCertificates*(trust: SecTrustRef;
    anchors: ptr CFArrayRef): OSStatus
## !
...
proc SecTrustSetVerifyDate*(trust: SecTrustRef; verifyDate: CFDateRef): OSStatus
## !
...
proc SecTrustGetVerifyTime*(trust: SecTrustRef): CFAbsoluteTime
## !
...
proc SecTrustEvaluate*(trust: SecTrustRef; result: ptr SecTrustResultType): OSStatus
## !
...
proc SecTrustEvaluateWithError*(trust: SecTrustRef; error: ptr CFErrorRef): bool
## !
...
proc SecTrustGetTrustResult*(trust: SecTrustRef; result: ptr SecTrustResultType): OSStatus
## !
...
proc SecTrustCopyPublicKey*(trust: SecTrustRef): SecKeyRef
## !
...
proc SecTrustGetCertificateCount*(trust: SecTrustRef): CFIndex
## !
...
proc SecTrustGetCertificateAtIndex*(trust: SecTrustRef; ix: CFIndex): SecCertificateRef
## !
...
proc SecTrustCopyExceptions*(trust: SecTrustRef): CFDataRef
## !
...
proc SecTrustSetExceptions*(trust: SecTrustRef; exceptions: CFDataRef): bool
## !
...
proc SecTrustCopyProperties*(trust: SecTrustRef): CFArrayRef
## !
...
proc SecTrustCopyResult*(trust: SecTrustRef): CFDictionaryRef
## !
...
proc SecTrustSetOCSPResponse*(trust: SecTrustRef; responseData: CFTypeRef): OSStatus
## !
...
proc SecTrustSetSignedCertificateTimestamps*(trust: SecTrustRef;
    sctArray: CFArrayRef): OSStatus
##
...
when TARGET_OS_OSX:
  ...
  ##
  proc SecTrustSetOptions*(trustRef: SecTrustRef; options: SecTrustOptionFlags): OSStatus
  ## !
  ...
  ##
  proc SecTrustSetParameters*(trustRef: SecTrustRef; action: CSSM_TP_ACTION;
                             actionData: CFDataRef): OSStatus
  ## !
  ...
  ##
  proc SecTrustSetKeychains*(trust: SecTrustRef; keychainOrArray: CFTypeRef): OSStatus
  ## !
  ...
  ##
  proc SecTrustGetResult*(trustRef: SecTrustRef; result: ptr SecTrustResultType;
                         certChain: ptr CFArrayRef;
                         statusChain: ptr ptr CSSM_TP_APPLE_EVIDENCE_INFO): OSStatus
  ## !
  ...
  ##
  proc SecTrustGetCssmResult*(trust: SecTrustRef;
                             result: ptr CSSM_TP_VERIFY_CONTEXT_RESULT_PTR): OSStatus
  ## !
  ...
  ##     use SecTrustGetTrustResult.
  ##
  proc SecTrustGetCssmResultCode*(trust: SecTrustRef; resultCode: ptr OSStatus): OSStatus
  ## !
  ...
  ##     @discussion This function is deprecated in OS X 10.7 and later.
  ##
  proc SecTrustGetTPHandle*(trust: SecTrustRef; handle: ptr CSSM_TP_HANDLE): OSStatus
  ## !
  ...
  ##
  proc SecTrustCopyAnchorCertificates*(anchors: ptr CFArrayRef): OSStatus