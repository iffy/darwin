...
var
  kSecKeyAttributeName*: CFStringRef
  kSecSignatureAttributeName*: CFStringRef
  kSecInputIsAttributeName*: CFStringRef
...
var
  kSecInputIsPlainText*: CFStringRef
  kSecInputIsDigest*: CFStringRef
  kSecInputIsRaw*: CFStringRef
...
proc SecSignTransformCreate*(key: SecKeyRef; error: ptr CFErrorRef): SecTransformRef
## !
...
proc SecVerifyTransformCreate*(key: SecKeyRef; signature: CFDataRef;
