...
type
  SecAFPServerSignature* = array[16, UInt8]
...
type
  SecPublicKeyHash* = array[20, UInt8]
...
proc SecKeychainItemGetTypeID*(): CFTypeID
## !
...
proc SecKeychainItemModifyAttributesAndData*(itemRef: SecKeychainItemRef;
    attrList: ptr SecKeychainAttributeList; length: UInt32; data: pointer): OSStatus
## !
...
proc SecKeychainItemCreateFromContent*(itemClass: SecItemClass;
                                      attrList: ptr SecKeychainAttributeList;
                                      length: UInt32; data: pointer;
...
proc SecKeychainItemModifyContent*(itemRef: SecKeychainItemRef;
                                  attrList: ptr SecKeychainAttributeList;
                                  length: UInt32; data: pointer): OSStatus
## !
...
proc SecKeychainItemCopyContent*(itemRef: SecKeychainItemRef;
                                itemClass: ptr SecItemClass;
                                attrList: ptr SecKeychainAttributeList;
                                length: ptr UInt32; outData: ptr pointer): OSStatus
## !
...
proc SecKeychainItemFreeContent*(attrList: ptr SecKeychainAttributeList;
                                data: pointer): OSStatus
## !
...
proc SecKeychainItemCopyAttributesAndData*(itemRef: SecKeychainItemRef;
    info: ptr SecKeychainAttributeInfo; itemClass: ptr SecItemClass;
    attrList: ptr ptr SecKeychainAttributeList; length: ptr UInt32;
    outData: ptr pointer): OSStatus
## !
...
proc SecKeychainItemFreeAttributesAndData*(
    attrList: ptr SecKeychainAttributeList; data: pointer): OSStatus
## !
...
proc SecKeychainItemDelete*(itemRef: SecKeychainItemRef): OSStatus
## !
...
proc SecKeychainItemCopyKeychain*(itemRef: SecKeychainItemRef;
                                 keychainRef: ptr SecKeychainRef): OSStatus
## !
...
proc SecKeychainItemCreateCopy*(itemRef: SecKeychainItemRef;
                               destKeychainRef: SecKeychainRef;
                               initialAccess: SecAccessRef;
                               itemCopy: ptr SecKeychainItemRef): OSStatus
## !
...
proc SecKeychainItemCreatePersistentReference*(itemRef: SecKeychainItemRef;
    persistentItemRef: ptr CFDataRef): OSStatus
## !
...
proc SecKeychainItemCopyFromPersistentReference*(persistentItemRef: CFDataRef;
    itemRef: ptr SecKeychainItemRef): OSStatus
## !
...
proc SecKeychainItemGetDLDBHandle*(keyItemRef: SecKeychainItemRef;
...
proc SecKeychainItemGetUniqueRecordID*(itemRef: SecKeychainItemRef; uniqueRecordID: ptr ptr CSSM_DB_UNIQUE_RECORD): OSStatus
## !
...
proc SecKeychainItemCopyAccess*(itemRef: SecKeychainItemRef;
                               access: ptr SecAccessRef): OSStatus
## !
...
proc SecKeychainItemSetAccess*(itemRef: SecKeychainItemRef; access: SecAccessRef): OSStatus