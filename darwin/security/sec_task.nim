...
proc SecTaskGetTypeID*(): CFTypeID
## !
...
proc SecTaskCreateWithAuditToken*(allocator: CFAllocatorRef; token: audit_token_t): SecTaskRef
## !
...
proc SecTaskCreateFromSelf*(allocator: CFAllocatorRef): SecTaskRef
## !
...
proc SecTaskCopyValueForEntitlement*(task: SecTaskRef; entitlement: CFStringRef;
                                    error: ptr CFErrorRef): CFTypeRef
## !
...
proc SecTaskCopyValuesForEntitlements*(task: SecTaskRef; entitlements: CFArrayRef;
...
proc SecTaskCopySigningIdentifier*(task: SecTaskRef; error: ptr CFErrorRef): CFStringRef
## !
...
proc SecTaskGetCodeSignStatus*(task: SecTaskRef): uint32_t