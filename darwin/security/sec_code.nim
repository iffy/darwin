...
proc SecCodeGetTypeID*(): CFTypeID
## !
...
proc SecCodeCopySelf*(flags: SecCSFlags; self: ptr SecCodeRef): OSStatus
## !
...
const
  kSecCSUseAllArchitectures* = 1 shl 0

proc SecCodeCopyStaticCode*(code: SecCodeRef; flags: SecCSFlags;
                           staticCode: ptr SecStaticCodeRef): OSStatus
## !
...
proc SecCodeCopyHost*(guest: SecCodeRef; flags: SecCSFlags; host: ptr SecCodeRef): OSStatus
var kSecGuestAttributeCanonical*: CFStringRef

var kSecGuestAttributeHash*: CFStringRef

var kSecGuestAttributeMachPort*: CFStringRef

var kSecGuestAttributePid*: CFStringRef

var kSecGuestAttributeAudit*: CFStringRef

var kSecGuestAttributeDynamicCode*: CFStringRef

var kSecGuestAttributeDynamicCodeInfoPlist*: CFStringRef

var kSecGuestAttributeArchitecture*: CFStringRef

var kSecGuestAttributeSubarchitecture*: CFStringRef
...
when TARGET_OS_OSX:
  ...
  ##
  proc SecCodeCopyGuestWithAttributes*(host: SecCodeRef;
                                      attributes: CFDictionaryRef;
                                      flags: SecCSFlags; guest: ptr SecCodeRef): OSStatus
## !
...
proc SecCodeCheckValidity*(code: SecCodeRef; flags: SecCSFlags;
                          requirement: SecRequirementRef): OSStatus
## !
...
proc SecCodeCheckValidityWithErrors*(code: SecCodeRef; flags: SecCSFlags;
                                    requirement: SecRequirementRef;
                                    errors: ptr CFErrorRef): OSStatus
## !
...
proc SecCodeCopyPath*(staticCode: SecStaticCodeRef; flags: SecCSFlags;
                     path: ptr CFURLRef): OSStatus
## !
...
proc SecCodeCopyDesignatedRequirement*(code: SecStaticCodeRef; flags: SecCSFlags;
                                      requirement: ptr SecRequirementRef): OSStatus
##
...
const
  kSecCSInternalInformation* = 1 shl 0
  kSecCSSigningInformation* = 1 shl 1
  kSecCSRequirementInformation* = 1 shl 2
  kSecCSDynamicInformation* = 1 shl 3
  kSecCSContentInformation* = 1 shl 4
  kSecCSSkipResourceDirectory* = 1 shl 5
  kSecCSCalculateCMSDigest* = 1 shl 6

##  flag required to get this value

var kSecCodeInfoCertificates*: CFStringRef

##  Signing

var kSecCodeInfoChangedFiles*: CFStringRef

##  Content

var kSecCodeInfoCMS*: CFStringRef

##  Signing

var kSecCodeInfoDesignatedRequirement*: CFStringRef

##  Requirement

var kSecCodeInfoEntitlements*: CFStringRef

##  generic

var kSecCodeInfoEntitlementsDict*: CFStringRef

##  generic

var kSecCodeInfoFlags*: CFStringRef

##  generic

var kSecCodeInfoFormat*: CFStringRef

##  generic

var kSecCodeInfoDigestAlgorithm*: CFStringRef

##  generic

var kSecCodeInfoDigestAlgorithms*: CFStringRef

##  generic

var kSecCodeInfoPlatformIdentifier*: CFStringRef

##  generic

var kSecCodeInfoIdentifier*: CFStringRef

##  generic

var kSecCodeInfoImplicitDesignatedRequirement*: CFStringRef

##  Requirement

var kSecCodeInfoMainExecutable*: CFStringRef

##  generic

var kSecCodeInfoPList*: CFStringRef

##  generic

var kSecCodeInfoRequirements*: CFStringRef

##  Requirement

var kSecCodeInfoRequirementData*: CFStringRef

##  Requirement

var kSecCodeInfoSource*: CFStringRef

##  generic

var kSecCodeInfoStatus*: CFStringRef

##  Dynamic

var kSecCodeInfoTeamIdentifier*: CFStringRef

##  Signing

var kSecCodeInfoTime*: CFStringRef

##  Signing

var kSecCodeInfoTimestamp*: CFStringRef

##  Signing

var kSecCodeInfoTrust*: CFStringRef

##  Signing

var kSecCodeInfoUnique*: CFStringRef

##  generic

var kSecCodeInfoCdHashes*: CFStringRef

##  generic

var kSecCodeInfoRuntimeVersion*: CFStringRef

## generic

proc SecCodeCopySigningInformation*(code: SecStaticCodeRef; flags: SecCSFlags;
                                   information: ptr CFDictionaryRef): OSStatus
##
...
proc SecCodeMapMemory*(code: SecStaticCodeRef; flags: SecCSFlags): OSStatus