...
const
  kSecTrustSettingsPolicy* = CFSTR("kSecTrustSettingsPolicy")
  kSecTrustSettingsApplication* = CFSTR("kSecTrustSettingsApplication")
  kSecTrustSettingsPolicyString* = CFSTR("kSecTrustSettingsPolicyString")
  kSecTrustSettingsKeyUsage* = CFSTR("kSecTrustSettingsKeyUsage")
  kSecTrustSettingsAllowedError* = CFSTR("kSecTrustSettingsAllowedError")
  kSecTrustSettingsResult* = CFSTR("kSecTrustSettingsResult")
...
type
  SecTrustSettingsKeyUsage* = uint32_t

const                         ##  sign/verify data
  kSecTrustSettingsKeyUseSignature* = 0x00000001 ##  bulk encryption
  kSecTrustSettingsKeyUseEnDecryptData* = 0x00000002 ##  key wrap/unwrap
  kSecTrustSettingsKeyUseEnDecryptKey* = 0x00000004 ##  sign/verify cert
  kSecTrustSettingsKeyUseSignCert* = 0x00000008 ##  sign/verify CRL and OCSP
  kSecTrustSettingsKeyUseSignRevocation* = 0x00000010 ##  key exchange, e.g., Diffie-Hellman
  kSecTrustSettingsKeyUseKeyExchange* = 0x00000020 ##  any usage (the default if this value is not specified)
...
type
  SecTrustSettingsResult* = uint32_t

const
  kSecTrustSettingsResultInvalid* = 0 ##  Never valid in a Trust Settings array or
                                   ##  in an API call.
  kSecTrustSettingsResultTrustRoot* = 1 ##  Root cert is explicitly trusted
  kSecTrustSettingsResultTrustAsRoot* = 2 ##  Non-root cert is explicitly trusted
  kSecTrustSettingsResultDeny* = 3 ##  Cert is explicitly distrusted
  kSecTrustSettingsResultUnspecified* = 4 ##  Neither trusted nor distrusted; evaluation
                                       ##  proceeds as usual
...
type
  SecTrustSettingsDomain* = uint32_t
...
const
  kSecTrustSettingsDefaultRootCertSetting* = ((SecCertificateRef) - 1)
...
when SEC_OS_OSX_INCLUDES:
  ...
  ##
  proc SecTrustSettingsCopyTrustSettings*(certRef: SecCertificateRef;
      domain: SecTrustSettingsDomain; trustSettings: ptr CFArrayRef): OSStatus
  ##  RETURNED
  ##
  ...
  ##
  proc SecTrustSettingsSetTrustSettings*(certRef: SecCertificateRef;
                                        domain: SecTrustSettingsDomain;
                                        trustSettingsDictOrArray: CFTypeRef): OSStatus
  ##
  ##  Delete Trust Settings for specified cert.
  ##  Returns errSecItemNotFound if no Trust settings exist for the cert.
  ##
  proc SecTrustSettingsRemoveTrustSettings*(certRef: SecCertificateRef;
      domain: SecTrustSettingsDomain): OSStatus
  ##
  ...
  ##
  proc SecTrustSettingsCopyCertificates*(domain: SecTrustSettingsDomain;
                                        certArray: ptr CFArrayRef): OSStatus
  ##
  ...
  ##  cert and domain.
  ##
  proc SecTrustSettingsCopyModificationDate*(certRef: SecCertificateRef;
      domain: SecTrustSettingsDomain; modificationDate: ptr CFDateRef): OSStatus
  ##  RETURNED
  ##
  ...
  ##  for the specified domain.
  ##
  proc SecTrustSettingsCreateExternalRepresentation*(
      domain: SecTrustSettingsDomain; trustSettings: ptr CFDataRef): OSStatus
  ##
  ##  Import trust settings, obtained via SecTrustSettingsCreateExternalRepresentation,
  ##  into the specified domain.
  ##
  proc SecTrustSettingsImportExternalRepresentation*(
      domain: SecTrustSettingsDomain; trustSettings: CFDataRef): OSStatus