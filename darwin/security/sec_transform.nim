...
var kSecTransformErrorDomain*: CFStringRef
...
var kSecTransformPreviousErrorKey*: CFStringRef
...
var kSecTransformAbortOriginatorKey*: CFStringRef
...
type
  SecTransformRef* = CFTypeRef
  SecGroupTransformRef* = CFTypeRef
...
proc SecTransformGetTypeID*(): CFTypeID
## !
...
proc SecGroupTransformGetTypeID*(): CFTypeID
...
var kSecTransformInputAttributeName*: CFStringRef
...
var kSecTransformOutputAttributeName*: CFStringRef
...
var kSecTransformDebugAttributeName*: CFStringRef
...
var kSecTransformTransformName*: CFStringRef
...
var kSecTransformAbortAttributeName*: CFStringRef
...
proc SecTransformCreateFromExternalRepresentation*(dictionary: CFDictionaryRef;
...
proc SecTransformCopyExternalRepresentation*(transformRef: SecTransformRef): CFDictionaryRef
## !
...
proc SecTransformCreateGroupTransform*(): SecGroupTransformRef
## !
...
proc SecTransformConnectTransforms*(sourceTransformRef: SecTransformRef;
                                   ...
                                   error: ptr CFErrorRef): SecGroupTransformRef
## !
...
proc SecTransformSetAttribute*(transformRef: SecTransformRef; key: CFStringRef;
                              value: CFTypeRef; error: ptr CFErrorRef): Boolean
## !
...
proc SecTransformGetAttribute*(transformRef: SecTransformRef; key: CFStringRef): CFTypeRef
## !
...
proc SecTransformFindByName*(transform: SecGroupTransformRef; name: CFStringRef): SecTransformRef
## !
...
proc SecTransformExecute*(transformRef: SecTransformRef; errorRef: ptr CFErrorRef): CFTypeRef
## !
...
type
  SecMessageBlock* = proc (message: CFTypeRef; error: CFErrorRef; isFinal: Boolean)
...
proc SecTransformExecuteAsync*(transformRef: SecTransformRef;
                              deliveryQueue: dispatch_queue_t;
