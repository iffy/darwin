...
proc SecStaticCodeGetTypeID*(): CFTypeID
## !
...
proc SecStaticCodeCreateWithPath*(path: CFURLRef; flags: SecCSFlags;
                                 staticCode: ptr SecStaticCodeRef): OSStatus
var kSecCodeAttributeArchitecture*: CFStringRef

var kSecCodeAttributeSubarchitecture*: CFStringRef

var kSecCodeAttributeUniversalFileOffset*: CFStringRef

var kSecCodeAttributeBundleVersion*: CFStringRef
...
proc SecStaticCodeCreateWithPathAndAttributes*(path: CFURLRef; flags: SecCSFlags;
    attributes: CFDictionaryRef; staticCode: ptr SecStaticCodeRef): OSStatus
## !
...
const
  kSecCSCheckAllArchitectures* = 1 shl 0
  kSecCSDoNotValidateExecutable* = 1 shl 1
  kSecCSDoNotValidateResources* = 1 shl 2
  kSecCSBasicValidateOnly* = kSecCSDoNotValidateExecutable or
      kSecCSDoNotValidateResources
  kSecCSCheckNestedCode* = 1 shl 3
  kSecCSStrictValidate* = 1 shl 4
  kSecCSFullReport* = 1 shl 5
  kSecCSCheckGatekeeperArchitectures* = (1 shl 6) or kSecCSCheckAllArchitectures
  kSecCSRestrictSymlinks* = 1 shl 7
  kSecCSRestrictToAppLike* = 1 shl 8
  kSecCSRestrictSidebandData* = 1 shl 9
  kSecCSUseSoftwareSigningCert* = 1 shl 10
  kSecCSValidatePEH* = 1 shl 11
  kSecCSSingleThreaded* = 1 shl 12

proc SecStaticCodeCheckValidity*(staticCode: SecStaticCodeRef; flags: SecCSFlags;
                                requirement: SecRequirementRef): OSStatus
proc SecStaticCodeCheckValidityWithErrors*(staticCode: SecStaticCodeRef;
    flags: SecCSFlags; requirement: SecRequirementRef; errors: ptr CFErrorRef): OSStatus